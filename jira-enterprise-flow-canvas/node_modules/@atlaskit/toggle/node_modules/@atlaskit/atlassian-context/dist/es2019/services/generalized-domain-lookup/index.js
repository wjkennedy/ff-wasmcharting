...
export function getDomainInContext(subdomain, envType) {
  const currentCloudEnvironment = cloudEnvironment();
...
function getDomainForNonIsolatedCloud(subdomain, perimeter, envType) {
  var _fullDomainOverride$s, _fullDomainOverride$s2;
  ...
  const override = (_fullDomainOverride$s = fullDomainOverride[subdomain]) === null || _fullDomainOverride$s === void 0 ? void 0 : (_fullDomainOverride$s2 = _fullDomainOverride$s[perimeter]) === null || _fullDomainOverride$s2 === void 0 ? void 0 : _fullDomainOverride$s2[envType];
  if (override) {
    return override;
  }
