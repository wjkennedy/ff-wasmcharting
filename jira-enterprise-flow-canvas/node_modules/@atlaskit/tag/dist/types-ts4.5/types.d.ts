export type TagColor = 'standard' | 'green' | 'lime' | 'blue' | 'red' | 'purple' | 'magenta' | 'grey' | 'gray' | 'teal' | 'orange' | 'yellow' | undefined | 'limeLight' | 'orangeLight' | 'magentaLight' | 'greenLight' | 'blueLight' | 'redLight' | 'purpleLight' | 'greyLight' | 'tealLight' | 'yellowLight';
