...
// Tag status enum
export let TagStatus = /*#__PURE__*/function (TagStatus) {
...
export function useLink(href, linkComponent) {
  ...
  const LinkComponent = linkComponent !== null && linkComponent !== void 0 ? linkComponent : Link;
  return {
    isLink,
    LinkComponent
  };
...
export function RemovableWrapper({
  ...
  if (isRemovable) {
    return /*#__PURE__*/React.createElement(ExitingPersistence, null, !(status === TagStatus.Removed) && /*#__PURE__*/React.createElement(ShrinkOut, null, motion => /*#__PURE__*/React.createElement("span", {
      ref: motion.ref
    }, children)));
  }
  return children;
