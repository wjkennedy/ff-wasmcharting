...
exports.toJSON = exports.mediaSingleWithWidthType = exports.mediaSingleWithCaption = exports.mediaSingleSpec = exports.mediaSingleFullWithLocalId = exports.mediaSingleFull = exports.mediaSingle = exports.defaultAttrs = void 0;
...
var mediaSingleSpec = exports.mediaSingleSpec = function mediaSingleSpec(_ref) {
  ...
  if (withExtendedWidthTypes && withCaption) {
    return (0, _nodeTypes.mediaSingleFull)({
      parseDOM: [{
  ...
  if (withExtendedWidthTypes && !withCaption) {
    return (0, _nodeTypes.mediaSingleWidthType)({
      parseDOM: [{
        tag: 'div[data-node-type="mediaSingle"]',
        getAttrs: getAttrs
      }],
  ...
  if (!withExtendedWidthTypes && withCaption) {
    return (0, _nodeTypes.mediaSingleCaption)({
      parseDOM: [{
        tag: 'div[data-node-type="mediaSingle"]',
        getAttrs: getAttrs
      }],
  ...
  return (0, _nodeTypes.mediaSingle)({
    parseDOM: [{
      tag: 'div[data-node-type="mediaSingle"]',
      getAttrs: getAttrs
    }],
...
var mediaSingle = exports.mediaSingle = mediaSingleSpec({
  withCaption: false,
  withExtendedWidthTypes: false
});
var mediaSingleWithCaption = exports.mediaSingleWithCaption = mediaSingleSpec({
  withCaption: true,
  withExtendedWidthTypes: false
});
var mediaSingleWithWidthType = exports.mediaSingleWithWidthType = mediaSingleSpec({
  withCaption: false,
  withExtendedWidthTypes: true
});
var mediaSingleFull = exports.mediaSingleFull = mediaSingleSpec({
  withCaption: true,
  withExtendedWidthTypes: true
});
var mediaSingleFullWithLocalId = exports.mediaSingleFullWithLocalId = mediaSingleSpec({
  withCaption: true,
  withExtendedWidthTypes: true,
