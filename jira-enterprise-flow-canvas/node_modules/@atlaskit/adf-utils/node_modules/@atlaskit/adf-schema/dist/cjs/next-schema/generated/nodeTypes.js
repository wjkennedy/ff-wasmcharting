...
var blockTaskItem = exports.blockTaskItem = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
...
var codeBlock = exports.codeBlock = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
...
var confluenceUnsupportedBlock = exports.confluenceUnsupportedBlock = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    cxhtml: {
      default: null
...
var confluenceUnsupportedInline = exports.confluenceUnsupportedInline = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  atom: true,
  attrs: {
...
var date = exports.date = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    timestamp: {
...
var dateStage0 = exports.dateStage0 = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    timestamp: {
...
var decisionItem = exports.decisionItem = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  content: 'inline*',
  marks: '_',
  attrs: {
    localId: {
...
var decisionList = exports.decisionList = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
...
var emoji = exports.emoji = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    shortName: {
...
var emojiStage0 = exports.emojiStage0 = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    shortName: {
...
var extensionWithMarks = exports.extensionWithMarks = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  atom: true,
  attrs: {
    extensionKey: {
...
var headingWithAlignment = exports.headingWithAlignment = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    level: {
      default: 1
...
var headingWithIndentation = exports.headingWithIndentation = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    level: {
      default: 1
...
var headingWithNoMarks = exports.headingWithNoMarks = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    level: {
      default: 1
...
var image = exports.image = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    src: {
...
var inlineCard = exports.inlineCard = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    url: {
...
var inlineCardStage0 = exports.inlineCardStage0 = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    url: {
...
var inlineExtension = exports.inlineExtension = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    extensionKey: {
...
var inlineExtensionWithMarks = exports.inlineExtensionWithMarks = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    extensionKey: {
...
var mediaInline = exports.mediaInline = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    type: {
...
var mediaSingle = exports.mediaSingle = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  atom: true,
  attrs: {
    layout: {
...
var mention = exports.mention = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    id: {
...
var mentionStage0 = exports.mentionStage0 = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    id: {
...
var nestedExpandWithNoMarks = exports.nestedExpandWithNoMarks = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  attrs: {
    title: {
      default: ''
    },
...
var paragraphWithAlignment = exports.paragraphWithAlignment = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    localId: {
      default: null
...
var paragraphWithIndentation = exports.paragraphWithIndentation = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    localId: {
      default: null
...
var paragraphWithNoMarks = exports.paragraphWithNoMarks = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'block',
  attrs: {
    localId: {
      default: null
...
var placeholder = exports.placeholder = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  marks: '',
  group: 'inline',
  inline: true,
  attrs: {
...
var statusStage0 = exports.statusStage0 = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    text: {
...
var tableWithNestedTable = exports.tableWithNestedTable = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  content: 'tableRow+',
  marks: 'unsupportedMark unsupportedNodeAttribute',
  group: 'block',
  attrs: {
...
var taskItem = exports.taskItem = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  content: 'inline*',
  marks: '_',
  attrs: {
    localId: {
...
var text = exports.text = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline'
});
var textCodeInline = exports.textCodeInline = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline'
});
...
var unsupportedInline = exports.unsupportedInline = (0, _createPMSpecFactory.createPMNodeSpecFactory)({
  group: 'inline',
  inline: true,
  attrs: {
    originalValue: {
