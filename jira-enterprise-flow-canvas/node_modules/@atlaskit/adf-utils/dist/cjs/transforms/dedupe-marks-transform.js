...
exports.transformDedupeMarks = void 0;
...
var transformDedupeMarks = exports.transformDedupeMarks = function transformDedupeMarks(adf) {
    ...
    text: function text(node) {
      if (maybeHasDisallowedDuplicateMarks(node)) {
        ...
        if (resultDiscardedMarks.length) {
          discardedMarks.push.apply(discardedMarks, (0, _toConsumableArray2.default)(resultDiscardedMarks));
          isTransformed = true;
          return result.node;
        }
      }
