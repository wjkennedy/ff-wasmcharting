...
export function OpenLayerObserverNamespaceProvider({
  ...
  useEffect(() => {
    invariant(parentContext === null, `An OpenLayerObserver namespace already exists in this component tree: ${parentContext}. Nesting OpenLayerObserverNamespaceProvider is not supported.`);
  }, [parentContext]);
