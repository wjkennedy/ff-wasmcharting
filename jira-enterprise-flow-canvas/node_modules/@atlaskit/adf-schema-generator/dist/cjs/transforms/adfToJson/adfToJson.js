...
exports.adfToJSON = adfToJSON;
exports.transform = transform;
var _slicedToArray2 = _interopRequireDefault(require("@babel/runtime/helpers/slicedToArray"));
var _traverse = require("../../traverse");
var _nodeBuilder = require("./nodeBuilder");
var _adfToJsonVisitor = require("./adfToJsonVisitor");
var _flow = _interopRequireDefault(require("lodash/flow"));
function transform(adf, fullSchema) {
  var result = {};
  (0, _traverse.traverse)(adf, (0, _adfToJsonVisitor.buildVisitor)(result, _nodeBuilder.buildNode, fullSchema));
...
adf) {
  var shouldGenerateFullSchema = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  return (0, _flow.default)(transform, fixCommonCompatibilityIssues, shouldGenerateFullSchema ? function (json) {
    return json;
  } : fixCompatibilityIssuesForStageZero)(adf, shouldGenerateFullSchema);
}

// Compatibility issues are grouped by nodes
function fixCommonCompatibilityIssues(json) {
  var _json$definitions, _json$definitions2, _json$definitions3, _json$definitions4, _json$definitions5, _json$definitions6, _json$definitions$tab, _json$definitions7, _json$definitions8, _json$definitions9;
  // Extra properties
  // @DSLCompatibilityException Despite being oneplus, doc has no minItems field
  (_json$definitions = json.definitions) === null || _json$definitions === void 0 || (_json$definitions = _json$definitions.doc_node.properties) === null || _json$definitions === void 0 || delete _json$definitions.content.minItems;
  /**
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function (v) {
    return !['bodiedExtension_node', 'extension_node', 'heading_node', 'layoutSection_node', 'mediaSingle_node', 'paragraph_node'].map(function (v) {
      return "#/definitions/".concat(v);
    }).includes(v.$ref);
  });
  ...
  if (json.definitions && json.definitions.inline_node && Array.isArray(json.definitions.inline_node.anyOf)) {
    ...
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
    function (v) {
      return !['#/definitions/confluenceJiraIssue_node', '#/definitions/confluenceUnsupportedInline_node', '#/definitions/image_node', '#/definitions/inlineExtension_node', '#/definitions/text_link_inline_node', '#/definitions/text_node', '#/definitions/unsupportedInline_node'].includes(v.$ref);
    });
  }
  ...
  (_json$definitions2 = json.definitions) === null || _json$definitions2 === void 0 || (_json$definitions2 = _json$definitions2.layoutSection_node.properties) === null || _json$definitions2 === void 0 || delete _json$definitions2.content.minItems;
  (_json$definitions3 = json.definitions) === null || _json$definitions3 === void 0 || (_json$definitions3 = _json$definitions3.layoutSection_node.properties) === null || _json$definitions3 === void 0 || delete _json$definitions3.content.maxItems;
  ...
  if (json.definitions && json.definitions.mediaSingle_node) {
    json.definitions.mediaSingle_node.required = json.definitions.mediaSingle_node.required.filter(function (v) {
      return v !== 'attrs';
    });
  ...
  (_json$definitions4 = json.definitions) === null || _json$definitions4 === void 0 || (_json$definitions4 = _json$definitions4.mediaInline_node.properties) === null || _json$definitions4 === void 0 || (_json$definitions4 = _json$definitions4.attrs.properties) === null || _json$definitions4 === void 0 || delete _json$definitions4.url;
  // @DSLCompatibilityException Find out why mediaInline has data in json but not in pm spec
  if ((_json$definitions5 = json.definitions) !== null && _json$definitions5 !== void 0 && (_json$definitions5 = _json$definitions5.mediaInline_node) !== null && _json$definitions5 !== void 0 && (_json$definitions5 = _json$definitions5.properties) !== null && _json$definitions5 !== void 0 && (_json$definitions5 = _json$definitions5.attrs) !== null && _json$definitions5 !== void 0 && _json$definitions5.properties) {
  ...
  if (json.definitions && Array.isArray(json.definitions.nestedExpand_content.allOf)) {
    var objectDef = json.definitions.nestedExpand_content.allOf.find(function (v) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function (v) {
    return v.$ref !== '#/definitions/nestedExpand_content';
  });
  if ((_json$definitions7 = json.definitions) !== null && _json$definitions7 !== void 0 && (_json$definitions7 = _json$definitions7.table_cell_node) !== null && _json$definitions7 !== void 0 && _json$definitions7.properties) {
    json.definitions.table_cell_node.properties.content = {
      $ref: "#/definitions/table_cell_content"
    };
  }
  if ((_json$definitions8 = json.definitions) !== null && _json$definitions8 !== void 0 && (_json$definitions8 = _json$definitions8.table_header_node) !== null && _json$definitions8 !== void 0 && _json$definitions8.properties) {
  ...
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  function (v) {
    return v.$ref !== '#/definitions/table_cell_content';
  });

  // @DSLCompatibilityException Despite being oneplus, tableRow has no minItems field
  (_json$definitions9 = json.definitions) === null || _json$definitions9 === void 0 || (_json$definitions9 = _json$definitions9.table_row_node.properties) === null || _json$definitions9 === void 0 || delete _json$definitions9.content.minItems;
  return json;
}
function fixCompatibilityIssuesForStageZero(json) {
  var _json$definitions0;
  // @DSLCompatibilityException Despite being oneplus, multiBodiedExtension_node has no minItems field
  (_json$definitions0 = json.definitions) === null || _json$definitions0 === void 0 || (_json$definitions0 = _json$definitions0.multiBodiedExtension_node.properties) === null || _json$definitions0 === void 0 || delete _json$definitions0.content.minItems;
  return json;
}