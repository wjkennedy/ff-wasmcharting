...
export type ADFAttributesAnyOf = {
    anyOf: Record<string, ADFAttribute>[];
};
export type ADFAttribute = ADFAttributeNumber | ADFAttributeString | ADFAttributeEnum | ADFAttributeBoolean | ADFAttributeArray | ADFAttributeObject;
