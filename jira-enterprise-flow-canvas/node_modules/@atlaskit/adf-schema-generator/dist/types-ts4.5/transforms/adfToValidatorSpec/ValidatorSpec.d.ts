...
export type ValidatorSpec = ValidatorSpecNode | ValidatorSpecNodeExtends | ValidatorSpecMark | ValidatorSpecGroup;
...
export type ValidatorSpecNodeExtends = [
    string,
    ValidatorSpecNode
];
...
export type ValidatorSpecAttributes = ValidatorSpecAttributesGroup | Array<ValidatorSpecAttributesGroup>;
