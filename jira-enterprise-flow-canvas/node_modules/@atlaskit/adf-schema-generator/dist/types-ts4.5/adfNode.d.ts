...
export declare class ADFNode<TVariantsNames extends Array<unknown> = [
     ...
     */
    variant<Name extends string, T extends ADFNodeSpec>(name: Name, spec: T): ADFNode<[
        ...TVariantsNames,
        Name
    ], TNodeSpecType & T>;
    /**
...
export declare function adfNode<Variant extends string, NodeSpecType extends ADFNodeSpec>(type: string): ADFNode<[
    Variant
], NodeSpecType>;
