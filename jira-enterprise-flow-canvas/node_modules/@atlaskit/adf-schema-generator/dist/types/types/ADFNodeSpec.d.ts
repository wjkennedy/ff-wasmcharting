...
export type DangerousManualOverride = Record<string, {
    reason: string;
    remove?: never;
    value: any;
} | {
...
export type ADFNodeContentSpec = ADFNodeContentOneOrMoreSpec | ADFNodeContentZeroOrMoreSpec | ADFNodeContentRangeSpec | ADFNodeContentOrSpec;
