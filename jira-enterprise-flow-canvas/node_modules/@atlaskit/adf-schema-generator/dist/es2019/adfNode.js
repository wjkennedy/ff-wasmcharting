...
export class ADFNode {
  ...
  variant(name, spec) {
    ...
    const baseSpec = {
      ..._classPrivateFieldGet(_spec, this)
    };
    ...
    const newAdfNode = new ADFNode(_classPrivateFieldGet(_type, this)).define(newSpec).setBase(this).setVariant(name);
   ...
   */
  getName(stage0 = false) {
    const stage0Suffix = stage0 && this.hasStage0() ? '_stage0' : '';
    if (_classPrivateFieldGet(_variant, this)) {
      return `${_classPrivateFieldGet(_type, this)}_${_classPrivateFieldGet(_variant, this)}${stage0Suffix}`;
    }
    return `${_classPrivateFieldGet(_type, this)}${stage0Suffix}`;
  }
  getSpec(stage0 = false) {
    if (stage0 && this.hasStage0()) {
      var _classPrivateFieldGet3, _classPrivateFieldGet4;
      return {
        ..._classPrivateFieldGet(_spec, this),
        ...(((_classPrivateFieldGet3 = _classPrivateFieldGet(_spec, this)) === null || _classPrivateFieldGet3 === void 0 ? void 0 : _classPrivateFieldGet3.stage0) === true ? {} : (_classPrivateFieldGet4 = _classPrivateFieldGet(_spec, this)) === null || _classPrivateFieldGet4 === void 0 ? void 0 : _classPrivateFieldGet4.stage0)
      };
    }
    return _classPrivateFieldGet(_spec, this);
  }
