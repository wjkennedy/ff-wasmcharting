...
export function pmNodeGroupsCodeGen(nodeGroupMap) {
  const uniqueTypeImports = new Set();
  ...
  const typeImportsArray = Array.from(uniqueTypeImports);
  typeImportsArray.sort();
  return _codeBlock(adfToPmAutogeneratedMessage, _namedTypeImport('./nodeTypes', ...typeImportsArray), groupTypesDefinitions.join('\n\n'));
}