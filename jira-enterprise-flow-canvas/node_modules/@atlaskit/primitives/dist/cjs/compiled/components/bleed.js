...
var Bleed = /*#__PURE__*/_react.default.memo(function (_ref) {
  ...
  return /*#__PURE__*/_react.default.createElement("div", {
    className: (0, _runtime.ax)([styles.root, all && styles["inline.".concat(all)], inline && styles["inline.".concat(inline)], all && styles["block.".concat(all)], block && styles["block.".concat(block)], xcss]),
    "data-testid": testId
  }, children);
});
