...
const queries = {
  ...
  'below.lg': typeof window === 'undefined' ? undefined : (_window0 = window) === null || _window0 === void 0 ? void 0 : (_window0$matchMedia = _window0.matchMedia) === null || _window0$matchMedia === void 0 ? void 0 : _window0$matchMedia.call(_window0, media.below.lg.replace('@media ', '').trim()),
  'below.xl': typeof window === 'undefined' ? undefined : (_window1 = window) === null || _window1 === void 0 ? void 0 : (_window1$matchMedia = _window1.matchMedia) === null || _window1$matchMedia === void 0 ? void 0 : _window1$matchMedia.call(_window1, media.below.xl.replace('@media ', '').trim())
};
