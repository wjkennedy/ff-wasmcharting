...
exports.createDateParser = void 0;
...
var INVARIANT_DATE = (0, _utils.toDate)(INVARIANT);
 ...
 * @returns DateParser
 */
var createDateParser = exports.createDateParser = function createDateParser(locale) {
  ...
  return function (date) {
    ...
    var normalizedDate = (0, _utils.normalizeDate)(extractedDate, options === null || options === void 0 ? void 0 : options.defaultFirstDay);
    if (!(0, _utils.isValid)(normalizedDate)) {
      return INVALID_DATE;
    }
    return (0, _utils.toDate)(normalizedDate);
  };
};