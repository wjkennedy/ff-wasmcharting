...
const metadata = {
  ...
  ask: {
    keywords: ['ask', 'icon', 'icon-lab', 'collaboration', 'hand shake', 'ask', 'focus', 'structured request', 'negotation', 'dependency'],
    componentName: 'AskIcon',
    package: '@atlaskit/icon-lab/core/ask',
    categorization: 'single-purpose',
    usage: 'Reserved for representing Asks in Focus. An ask is structured request made by one team or user to another, representing work needed to complete other work.',
    team: 'Focus',
    status: 'published'
  },
  'assets-data-manager': {
  ...
  editions: {
    ...
    categorization: 'single-purpose',
    usage: 'Reserved for representing premium features in upsell experiences. The Editions gem icon has officially replaced the sparkle icon.',
    team: 'Design System Team',
    status: 'published'
  },
  'expand-element': {
