...
export type Callback = (time: number, box: DOMRectReadOnly, targetName: string, node: HTMLElement, type: ObservedMutationType, ignoreReason?: VCIgnoreReason, attributeName?: string | null, oldValue?: string | null, newValue?: string | null) => void;
