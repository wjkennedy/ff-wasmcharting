...
type ReactUFOAttributesProperties = ExtractPromise<ReturnType<typeof createPayloads>>[number]['attributes']['properties'];
    ...
    attributes: {
        properties: ReactUFOAttributesProperties & {
            ...
            'metrics:navigation': {
                ...
                workerStart: number;
                nextHopProtocol: 'http/0.9' | 'http/1.0' | 'http/1.1' | 'h2' | 'h2c' | 'h3';
            };
